...
sample_weights = y_train_val.apply(lambda x: 1 if x == 0 else 1.5)
...
ax.set_title("Model Comparison Based on Evaluation Metrics (3 Features)")
ax.set_ylabel("Score")
ax.set_xlabel("Model")
ax.legend(title="Metrics", loc="upper left", bbox_to_anchor=(1, 1))

# Save the figure
output_path = 'Model Comparison Based on Evaluation Metrics (3 Features).png'
fig.savefig(output_path, bbox_inches='tight')
plt.show()

metrics_df.to_csv("model_comparison_3.csv", index=False)
