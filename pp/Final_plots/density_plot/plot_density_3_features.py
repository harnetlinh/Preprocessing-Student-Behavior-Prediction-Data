...
axs[0].set_title("Distribution of Average Score", fontsize=28)
axs[0].set_xlabel("Average Score", fontsize=28)
axs[0].set_ylabel("", fontsize=28)
...
axs[1].set_title("Distribution of Attendance Rate", fontsize=28)
axs[1].set_xlabel("Attendance Rate", fontsize=28)
axs[1].set_ylabel("", fontsize=28)
...
axs[2].set_title("Distribution of Passed Credit Rate", fontsize=28)
axs[2].set_xlabel("Passed Credit Rate", fontsize=28)
axs[2].set_ylabel("", fontsize=28)
