...
sns.histplot(data=df, x="semester_1_average_score", hue="Dropout Status", kde=True, ax=axs[0,0])
axs[0,0].set_title("Distribution of Average Score Semester 1", fontsize=28)
axs[0,0].set_xlabel("Average Score", fontsize=28)
axs[0,0].set_ylabel("Density", fontsize=28)
axs[0,0].tick_params(axis='x', labelsize=28)
axs[0,0].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_2_average_score", hue="Dropout Status", kde=True, ax=axs[0,1])
axs[0,1].set_title("Distribution of Average Score Semester 2", fontsize=28)
axs[0,1].set_xlabel("Average Score", fontsize=28)
axs[0,1].set_ylabel("Density", fontsize=28)
axs[0,1].tick_params(axis='x', labelsize=28)
axs[0,1].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_3_average_score", hue="Dropout Status", kde=True, ax=axs[0,2])
axs[0,2].set_title("Distribution of Average Score Semester 3", fontsize=28)
axs[0,2].set_xlabel("Average Score", fontsize=28)
axs[0,2].set_ylabel("Density", fontsize=28)
axs[0,2].tick_params(axis='x', labelsize=28)
axs[0,2].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_1_attendance_rate", hue="Dropout Status", kde=True, ax=axs[1,0])
axs[1,0].set_title("Distribution of Attendance Rate Semester 1", fontsize=28)
axs[1,0].set_xlabel("Attendance Rate", fontsize=28)
axs[1,0].set_ylabel("Density", fontsize=28)
axs[1,0].tick_params(axis='x', labelsize=28)
axs[1,0].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_2_attendance_rate", hue="Dropout Status", kde=True, ax=axs[1,1])
axs[1,1].set_title("Distribution of Attendance Rate Semester 2", fontsize=28)
axs[1,1].set_xlabel("Attendance Rate", fontsize=28)
axs[1,1].set_ylabel("Density", fontsize=28)
axs[1,1].tick_params(axis='x', labelsize=28)
axs[1,1].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_3_attendance_rate", hue="Dropout Status", kde=True, ax=axs[1,2])
axs[1,2].set_title("Distribution of Attendance Rate Semester 3", fontsize=28)
axs[1,2].set_xlabel("Attendance Rate", fontsize=28)
axs[1,2].set_ylabel("Density", fontsize=28)
axs[1,2].tick_params(axis='x', labelsize=28)
axs[1,2].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_1_passed_percent", hue="Dropout Status", kde=True, ax=axs[2,0])
axs[2,0].set_title("Distribution of Passed Credit Percentage Semester 1", fontsize=28)
axs[2,0].set_xlabel("Passed Credit Percentage", fontsize=28)
axs[2,0].set_ylabel("Density", fontsize=28)
axs[2,0].tick_params(axis='x', labelsize=28)
axs[2,0].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_2_passed_percent", hue="Dropout Status", kde=True, ax=axs[2,1])
axs[2,1].set_title("Distribution of Passed Credit Percentage Semester 2", fontsize=28)
axs[2,1].set_xlabel("Passed Credit Percentage", fontsize=28)
axs[2,1].set_ylabel("Density", fontsize=28)
axs[2,1].tick_params(axis='x', labelsize=28)
axs[2,1].tick_params(axis='y', labelsize=28)

sns.histplot(data=df, x="semester_3_passed_percent", hue="Dropout Status", kde=True, ax=axs[2,2])
axs[2,2].set_title("Distribution of Passed Credit Percentage Semester 3", fontsize=28)
axs[2,2].set_xlabel("Passed Credit Percentage", fontsize=28)
axs[2,2].set_ylabel("Density", fontsize=28)
axs[2,2].tick_params(axis='x', labelsize=28)
axs[2,2].tick_params(axis='y', labelsize=28)

# Save the figure
output_path = '9_features_new.png'
