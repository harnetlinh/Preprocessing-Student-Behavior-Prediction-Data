...
axs[2,0].set_title("Distribution of Passed Credit Rate Semester 1", fontsize=20)
axs[2,0].set_xlabel("Passed Credit Rate", fontsize=20)
...
axs[2,1].set_title("Distribution of Passed Credit Rate Semester 2", fontsize=20)
axs[2,1].set_xlabel("Passed Credit Rate", fontsize=20)
...
axs[2,2].set_title("Distribution of Passed Credit Rate Semester 3", fontsize=20)
axs[2,2].set_xlabel("Passed Credit Rate", fontsize=20)
axs[2,2].set_ylabel("", fontsize=20)
