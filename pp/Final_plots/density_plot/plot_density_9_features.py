...
axs[0,0].set_title("Distribution of Average Score Semester 1", fontsize=12)
axs[0,0].set_xlabel("Average Score", fontsize=12)
...
axs[0,0].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[0,0].add_artist(axs[0,0].get_legend())
axs[0,0].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_2_average_score", hue="Dropout Status", kde=True, ax=axs[0,1], stat='percent', common_norm=False)
axs[0,1].set_title("Distribution of Average Score Semester 2", fontsize=12)
axs[0,1].set_xlabel("Average Score", fontsize=12)
...
axs[0,1].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[0,1].add_artist(axs[0,1].get_legend())
axs[0,1].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_3_average_score", hue="Dropout Status", kde=True, ax=axs[0,2], stat='percent', common_norm=False)
axs[0,2].set_title("Distribution of Average Score Semester 3", fontsize=12)
axs[0,2].set_xlabel("Average Score", fontsize=12)
axs[0,2].set_ylabel("", fontsize=12)
axs[0,2].tick_params(axis='x', labelsize=12)
axs[0,2].tick_params(axis='y', labelsize=12)
...
axs[0,2].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[0,2].add_artist(axs[0,2].get_legend())
axs[0,2].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_1_attendance_rate", hue="Dropout Status", kde=True, ax=axs[1,0], stat='percent', common_norm=False)
axs[1,0].set_title("Distribution of Attendance Rate Semester 1", fontsize=12)
axs[1,0].set_xlabel("Attendance Rate", fontsize=12)
...
axs[1,0].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[1,0].add_artist(axs[1,0].get_legend())
axs[1,0].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_2_attendance_rate", hue="Dropout Status", kde=True, ax=axs[1,1], stat='percent', common_norm=False)
axs[1,1].set_title("Distribution of Attendance Rate Semester 2", fontsize=12)
axs[1,1].set_xlabel("Attendance Rate", fontsize=12)
...
axs[1,1].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[1,1].add_artist(axs[1,1].get_legend())
axs[1,1].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_3_attendance_rate", hue="Dropout Status", kde=True, ax=axs[1,2], stat='percent', common_norm=False)
axs[1,2].set_title("Distribution of Attendance Rate Semester 3", fontsize=12)
axs[1,2].set_xlabel("Attendance Rate", fontsize=12)
axs[1,2].set_ylabel("", fontsize=12)
axs[1,2].tick_params(axis='x', labelsize=12)
...
axs[1,2].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[1,2].add_artist(axs[1,2].get_legend())
axs[1,2].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_1_passed_percent", hue="Dropout Status", kde=True, ax=axs[2,0], stat='percent', common_norm=False)
axs[2,0].set_title("Distribution of Passed Credit Rate Semester 1", fontsize=12)
axs[2,0].set_xlabel("Passed Credit Rate", fontsize=12)
axs[2,0].set_ylabel("", fontsize=12)
...
axs[2,0].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[2,0].add_artist(axs[2,0].get_legend())
axs[2,0].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_2_passed_percent", hue="Dropout Status", kde=True, ax=axs[2,1], stat='percent', common_norm=False)
axs[2,1].set_title("Distribution of Passed Credit Rate Semester 2", fontsize=12)
axs[2,1].set_xlabel("Passed Credit Rate", fontsize=12)
axs[2,1].set_ylabel("", fontsize=12)
...
axs[2,1].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[2,1].add_artist(axs[2,1].get_legend())
axs[2,1].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)

sns.histplot(data=df, x="semester_3_passed_percent", hue="Dropout Status", kde=True, ax=axs[2,2], stat='percent', common_norm=False)
axs[2,2].set_title("Distribution of Passed Credit Rate Semester 3", fontsize=12)
axs[2,2].set_xlabel("Passed Credit Rate", fontsize=12)
axs[2,2].set_ylabel("", fontsize=12)
axs[2,2].tick_params(axis='x', labelsize=12)
axs[2,2].tick_params(axis='y', labelsize=12)
...
axs[2,2].legend(handles=hue_handles, title='Dropout Status', loc='upper right', fontsize=12, title_fontsize=12)
axs[2,2].add_artist(axs[2,2].get_legend())
axs[2,2].legend(handles=mean_line + median_line + mode_line, title='Statistics', loc='upper left', fontsize=12, title_fontsize=12)
