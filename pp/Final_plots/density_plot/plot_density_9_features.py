...
axs[0,0].set_title("Distribution of Average Score Semester 1", fontsize=20)
...
axs[0,1].set_title("Distribution of Average Score Semester 2", fontsize=20)
...
axs[0,2].set_title("Distribution of Average Score Semester 3", fontsize=20)
...
axs[1,0].set_title("Distribution of Attendance Rate Semester 1", fontsize=20)
...
axs[1,1].set_title("Distribution of Attendance Rate Semester 2", fontsize=20)
...
axs[1,2].set_title("Distribution of Attendance Rate Semester 3", fontsize=20)
...
axs[2,0].set_title("Distribution of Passed Credit Percentage Semester 1", fontsize=20)
...
axs[2,1].set_title("Distribution of Passed Credit Percentage Semester 2", fontsize=20)
...
axs[2,2].set_title("Distribution of Passed Credit Percentage Semester 3", fontsize=20)
