...
df_resampled_sem3 = df_resampled[["semester_3_attendance_rate", "semester_3_average_score", "dropout_status"]]

# Correlation Matrix to evaluate after resampling with SMOTE
fig, ax = plt.subplots(figsize=(14, 10))
sns.heatmap(df_resampled_sem3.corr(), annot=True, annot_kws={'size': 15}, cmap='crest', linewidths=.1)
ax.set_title('Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status in Semester 3 (After resampling)')
plt.show()
# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status in Semester 3 (After resampling).png'
