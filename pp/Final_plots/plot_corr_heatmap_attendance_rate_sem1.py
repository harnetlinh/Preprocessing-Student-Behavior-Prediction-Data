...
pivot_df = combine_df.pivot(index=['student_code', 'dropout_status'], columns='subject_code', values=['attendance_rate'])
...
ax.set_title('Correlation Matrix Heatmap of Attendance Rate with Dropout Status in Semester 1', fontsize=42)
...
# Save the figure
output_path = 'Correlation Matrix Heatmap of Attendance Rate with Dropout Status in Semester 1.png'
