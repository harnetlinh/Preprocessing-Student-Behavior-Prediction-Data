...
selected_df = combine_data[["semester_1_average_score", "semester_2_average_score", "semester_3_average_score",
                            "semester_1_attendance_rate", "semester_2_attendance_rate", "semester_3_attendance_rate",
                            "dropout_status"]]
...
ax.set_title('Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status')
ax.tick_params(axis='x', labelrotation=45)
plt.show()

# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status.png'
