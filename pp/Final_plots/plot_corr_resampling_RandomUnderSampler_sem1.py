...
ax.set_title('Correlation Matrix Heatmap in Semester 1 (Undersampling - RandomUnderSampler)')
plt.show()

# Save the figure
output_path = 'Correlation Matrix Heatmap in Semester 1 (Undersampling - RandomUnderSampler).png'
