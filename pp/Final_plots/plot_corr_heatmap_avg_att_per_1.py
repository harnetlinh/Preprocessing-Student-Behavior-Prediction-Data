...
cg_df["passed_percent_1"] = cg_df["credit_passed_1"] / cg_df["total_credit_1"] * 100
...
selected_df = merged_df[["semester_1_average_score", "passed_percent_1", "semester_1_attendance_rate", "dropout_status"]]
...
ax.set_title('Correlation Matrix Heatmap of Average Score, Attendance Rate, Passed Credit Percentage with Dropout Status in Semester 1')
plt.show()

# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score, Attendance Rate, Passed Credit Percentage with Dropout Status in Semester 1.png'
