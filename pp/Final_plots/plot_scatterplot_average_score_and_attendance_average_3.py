...
sns.scatterplot(x='semester_3_attendance_rate', y='semester_3_average_score', hue='dropout_status', style='dropout_status', markers=['X', 'o'], data=combine_data, ax=ax)
ax.set_title('Scatter Plot of Attendance Rate vs. Average Score for Semester 3')
ax.set_xlabel('Attendance Rate')
ax.set_ylabel('Average Score')
ax.legend(title='Student Status On Semester 3')

# Save the figure
output_path = 'scatter_plot_semester_3_markers.png'
