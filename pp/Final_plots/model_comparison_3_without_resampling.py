...
# Save the figure
output_path = 'Model Comparison Based on Evaluation Metrics (3 Features) without Resampling.png'
fig.savefig(output_path, bbox_inches='tight')
plt.show()

metrics_df.to_csv("model_comparison_3_without_resampling.csv", index=False)
