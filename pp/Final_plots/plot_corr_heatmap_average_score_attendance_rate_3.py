...
selected_df = combine_data[["semester_3_average_score", "semester_3_attendance_rate", "dropout_status"]]
...
ax.set_title('Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status in Semester 3.png')
plt.show()

# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status in Semester 3.png'
