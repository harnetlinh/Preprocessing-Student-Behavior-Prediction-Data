...
ax.set_title("Model Comparison Based on Evaluation Metrics (2 Features)")
ax.set_ylabel("Score")
ax.set_xlabel("Model")
ax.legend(title="Metrics", loc="upper left", bbox_to_anchor=(1, 1))

# Save the figure
output_path = 'Model Comparison Based on Evaluation Metrics (2 Features) without Resampling.png'
fig.savefig(output_path, bbox_inches='tight')
plt.show()

metrics_df.to_csv("model_comparison_2_without_resampling.csv", index=False)
