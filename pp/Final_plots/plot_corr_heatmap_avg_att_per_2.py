...
combine_df["total_credit_2"] = combine_df["number_of_credit"] * combine_df["learnt_times"]

combine_df["credit_passed_2"] = (1 / combine_df["learnt_times"] * combine_df["total_credit_2"]).where(combine_df["passed"] == True, 0)
...
cg_df["passed_percent_2"] = cg_df["credit_passed_2"] / cg_df["total_credit_2"] * 100
...
selected_df = merged_df[["semester_2_average_score", "passed_percent_2", "semester_2_attendance_rate", "dropout_status"]]
...
ax.set_title('Correlation Matrix Heatmap of Average Score, Attendance Rate, Passed Credit Percentage with Dropout Status in Semester 2')
plt.show()

# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score, Attendance Rate, Passed Credit Percentage with Dropout Status in Semester 2.png'
