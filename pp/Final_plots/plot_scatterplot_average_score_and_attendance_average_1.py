...
sns.scatterplot(x='semester_1_attendance_rate', y='semester_1_average_score', hue='dropout_status', style='dropout_status', markers=['X', 'o'], data=combine_data, ax=ax)
ax.set_title('Scatter Plot of Attendance Rate vs. Average Score for Semester 1')
ax.set_xlabel('Attendance Rate')
ax.set_ylabel('Average Score')
ax.legend(title='Student Status On Semester 3')

# Save the figure
output_path = 'scatter_plot_semester_1_markers.png'
