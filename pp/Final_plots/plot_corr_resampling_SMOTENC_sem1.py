...
# Correlation Matrix to evaluate after resampling with SMOTENC
fig, ax = plt.subplots(figsize=(14, 10))
sns.heatmap(df_resampled.corr(), annot=True, annot_kws={'size': 15}, cmap='crest', linewidths=.1)
ax.set_title('Correlation Matrix Heatmap in Semester 1 (Oversampling - SMOTENC)')
plt.show()

# Save the figure
output_path = 'Correlation Matrix Heatmap in Semester 1 (Oversampling - SMOTENC).png'
