...
df_resampled_sem2 = df_resampled[["semester_2_attendance_rate", "semester_2_average_score", "dropout_status"]]

# Correlation Matrix to evaluate after resampling with SMOTE
fig, ax = plt.subplots(figsize=(14, 10))
sns.heatmap(df_resampled_sem2.corr(), annot=True, annot_kws={'size': 15}, cmap='crest', linewidths=.1)
ax.set_title('Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status in Semester 2 (After resampling)')
plt.show()
# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score and Attendance Rate with Dropout Status in Semester 2 (After resampling).png'
