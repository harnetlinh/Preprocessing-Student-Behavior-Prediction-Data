...
ax.set_title('Correlation Matrix Heatmap of Average Score with Dropout Status in Semester 2', fontsize=42)
...
# Save the figure
output_path = 'Correlation Matrix Heatmap of Average Score with Dropout Status in Semester 2.png'
